...
window.joinRoom = async function () {
  ...
  try {
    ...
    // Kirim frame dari local video ke Firebase
    setInterval(() => {
...
captureBtn.onclick = () => {
  ...
  ctx.drawImage(remoteImg, width / 2, 0, width / 2, height);
